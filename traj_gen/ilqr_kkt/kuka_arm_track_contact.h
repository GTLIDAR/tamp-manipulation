...
#ifndef KUKAARM_TRACK_CONTACT_H
#define KUKAARM_TRACK_CONTACT_H
...
public:
    KukaArm_TRK_Contact();
    KukaArm_TRK_Contact(double& iiwa_dt, unsigned int& iiwa_N, stateVec_t& iiwa_xgoal, string action_name);
    KukaArm_TRK_Contact(double& iiwa_dt, unsigned int& iiwa_N, stateVec_t& iiwa_xgoal, MultibodyPlant<double>* plant, string action_name);
    ~KukaArm_TRK_Contact(){};
private:
protected:
    // attributes
...
public:
    ...
    void kuka_arm_dyn_cst_ilqr(const int& nargout, const stateVecTab_t& xList, const commandVecTab_t& uList, stateVecTab_t& FList, const stateVecTab_t& xList_bar, const commandVecTab_t& uList_bar, CostFunctionKukaArm_TRK_Contact*& costFunction);
    void kuka_arm_dyn_cst_min_output(const int& nargout, const stateVec_t& xList_curr, const commandVec_t& uList_curr,  const stateVec_t& xList_cur_bar, const commandVec_t& uList_cur_bar, const bool& isUNan, stateVec_t& xList_next, CostFunctionKukaArm_TRK_Contact*& costFunction);
    void kuka_arm_dyn_cst_udp(const int& nargout, const stateVecTab_t& xList, const commandVecTab_t& uList, stateVecTab_t& FList, CostFunctionKukaArm_TRK_Contact*& costFunction);
