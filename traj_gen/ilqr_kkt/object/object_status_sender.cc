...
ObjectStatusSender::ObjectStatusSender(int num_joints)
  ...
  this->DeclareAbstractOutputPort(
      "lcmt_object_status", &ObjectStatusSender::CalcOutput);
}

using InPort = systems::InputPort<double>;
const InPort& ObjectStatusSender::get_position_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(0);
}
const InPort& ObjectStatusSender::get_position_measured_input_port() const {
  return LeafSystem<double>::get_input_port(1);
}
const InPort& ObjectStatusSender::get_velocity_estimated_input_port() const {
  return LeafSystem<double>::get_input_port(2);
}
const InPort& ObjectStatusSender::get_torque_commanded_input_port() const {
  return LeafSystem<double>::get_input_port(3);
}
const InPort& ObjectStatusSender::get_torque_measured_input_port() const {
  return LeafSystem<double>::get_input_port(4);
}
const InPort& ObjectStatusSender::get_torque_external_input_port() const {
  return LeafSystem<double>::get_input_port(5);
}
const systems::OutputPort<double>& ObjectStatusSender::get_output_port() const {
...
void ObjectStatusSender::CalcOutput(
    const systems::Context<double>& context, lcmt_object_status* output) const {
  ...
  lcmt_object_status& status = *output;
