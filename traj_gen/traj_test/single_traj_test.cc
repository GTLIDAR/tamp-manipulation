...
int main(int argc, char* argv[]) {
    ...
    double prev_q[] = {-0.2409019355863915, 1.2287647083232374, 0.10315585492596784, -1.3773293517109657, -0.23718952292265003, -1.022334841872332, 0.02442955964457319}; // for traj 14
    ...
    double desired_ee[] = {0.38, 0.38, 0.45, 0.0, 0.0, 0.707};
    for (int i = 0; i < 6; i++) {
        query.desired_ee[i] = desired_ee[i];
    }
