...
public:
    ...
    void kuka_arm_dyn_cst_min_output(const int& nargout, const stateVec_t& xList_curr, 
    const commandVec_t& uList_curr,  const bool& isUNan, stateVec_t& xList_next, 
    commandVec_t uList_prev, CostFunctionKukaArm*& costFunction);
