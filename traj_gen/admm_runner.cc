...
lcmt_ddp_traj ADMMRunner::RunADMM(stateVec_t xinit, stateVec_t xgoal, 
  const lcmt_motion_plan_query* query) {
    ...
    // std::string _file_name = "/home/zzhou387/drake/traj_gen/trajectory/"; //UDP_TRAJ_DIR;
    // _file_name += "joint_torque_command";
    // _file_name += ".csv";
    ...
    // for (unsigned int kkk=0; kkk<N; kkk++)
    //     std::cout << "double csv: " << kkk << u_0[kkk].transpose() << std::endl;
    //======================================================================
    //======================================================================
    ...
    //TODO: There is a small difference between trajectories generated by DDP and xnew?
    // for(unsigned int i=0;i<=N;i++)
    // {
    //   // cout << "init_u[" << i << "]:" << (unew[i]-u_0[i]).transpose() << endl;
    //   cout << "init_x[" << i << "]:" << xnew[i].transpose() << endl;
...
//     }
    ...
    // cout << "-------- ADMM Trajectory Published to LCM! --------" << endl;
    return *ptr;
  }
