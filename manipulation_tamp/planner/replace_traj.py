...
JSON_DEST_FILENAME = drake_path + "/manipulation_tamp/results/admm_traj20210102T185120.json"
JSON_SRC_FILENAME = drake_path + "/manipulation_tamp/results/admm_traj20210103T151122.json"
