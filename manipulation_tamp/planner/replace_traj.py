...
JSON_DEST_FILENAME = drake_path + "/manipulation_tamp/results/conv_belt_ca_updated.json"
JSON_SRC_FILENAME = drake_path + "/manipulation_tamp/results/con28.json"
JSON_OUT_FILENAME = drake_path + "/manipulation_tamp/results/conv_belt_ca_updated.json"
