...
void ManipulationStation<T>::SetupObjectSortingStation(
  ...
  // Add Table that supports Iiwa
  {
    const std::string sdf_path = FindResourceOrThrow(
      "drake/manipulation_tamp/models/furnitures/"
...
void ManipulationStation<T>::SetupConveyorBeltStation(
  ...
  // Add the bins.
  {
    ...
    const std::string sdf_path = FindResourceOrThrow(
        "drake/manipulation_tamp/models/furnitures/bin.sdf");
...
template class ::drake::manipulation_tamp::manipulation_station::ManipulationStation<
    double>;
