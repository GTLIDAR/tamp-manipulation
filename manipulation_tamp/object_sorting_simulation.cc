...
DEFINE_string(geo_setup_file, "drake/manipulation_tamp/setup/object_sorting/geo_setup.json",
...
int do_main(int argc, char* argv[]) {
    ...
    {
    const std::string box_urdf_path = "drake/manipulation_tamp/models/boxes/black_box3.urdf";
    ...
    // box_4
    {
    const std::string box_urdf_path = "drake/manipulation_tamp/models/boxes/black_box4.urdf";
    ...
    // box_5
    {
    const std::string box_urdf_path = "drake/manipulation_tamp/models/boxes/redblock2.urdf";
    ...
    auto xyz = Eigen::Vector3d(
        object_init_pos["box_5"][0].asDouble() + xAdditionalOffset,
        object_init_pos["box_5"][1].asDouble() + yAdditionalOffset,
    ...
    // box_6
    {
    const std::string box_urdf_path = "drake/manipulation_tamp/models/boxes/black_box5.urdf";
    ...
    auto xyz = Eigen::Vector3d(
        object_init_pos["box_6"][0].asDouble() + xAdditionalOffset,
        object_init_pos["box_6"][1].asDouble() + yAdditionalOffset,
    ...
    // box_7
    {
    const std::string box_urdf_path = "drake/manipulation_tamp/models/boxes/black_box6.urdf";
    ...
    auto xyz = Eigen::Vector3d(
        object_init_pos["box_7"][0].asDouble() + xAdditionalOffset,
        object_init_pos["box_7"][1].asDouble() + yAdditionalOffset,
    ...
    // box_8
    {
    const std::string box_urdf_path = "drake/manipulation_tamp/models/boxes/black_box7.urdf";
    ...
    // box_9
    {
    const std::string box_urdf_path = "drake/manipulation_tamp/models/boxes/black_box8.urdf";
    ...
    // box_10
    {
    const std::string box_urdf_path = "drake/manipulation_tamp/models/boxes/black_box9.urdf";
