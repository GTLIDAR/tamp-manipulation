...
int do_main(int argc, char* argv[]) {
    ...
    // box_6
    {
    const std::string box_urdf_path = "drake/conveyor_belt_tamp/models/boxes/black_box5.urdf";
    ...
    // box_7
    {
    const std::string box_urdf_path = "drake/conveyor_belt_tamp/models/boxes/black_box6.urdf";
